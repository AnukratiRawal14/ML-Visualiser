import 'package:flutter/material.dart';
   ...
   const kCardShape = RoundedRectangleBorder( borderRadius: BorderRadius.all(Radius.circular(8)), );
   const kCardElevation = 0.0;
   const kCardDivider = Divider( color: Color(0xFFFFFFFF) , height: 1.0 , thickness: 8.0,);
   const kSizedBox = SizedBox( height: 5.0,);
